...
float pattern(in vec2 p) {
    ...
    vec2 bScale = vec2(1.5); //this scale changes the main distortion density. less = smoky, more = oily
...
vec3 palette(in float t) {
    vec3 a = vec3(0.6, 0.6, 0.55);
    vec3 b = vec3(0.45, 0.35, 0.14);
    vec3 c = vec3(01 ,1, 1.0);
